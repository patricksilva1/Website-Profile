  ...
  <Layout>
    <div class="hero container-inner mx-auto flex flex-col sm:flex-row justify-between py-16 mt-8">
      <div class="text-4xl font-bold w-full sm:w-3/5 text-center sm:text-left">
        <div class="leading-tight">Oh, hello! Welcome and feel free,</div>
        <div class="text-green-1000 leading-tight">Welcome to my website!</div>
      </div>
    ...
    <!--This gridsome theme was forked from my <a href="https://.com">personal website</a>.-->
    <div class="container-inner mx-auto">
      <p class="text-lg sm:text-xl">
        Greetins! I'm Patrick, a Software Engineer from Brazil. I speak English, Portuguese and a little Spanish (I'm
        training French rn). Ex-member of CFN (Brazilian Marine Corps) acted with Software Development and Network
        Security. A guy with a deep interest in technology and how it can benefit us in our lives.

        I spend my days designing and developing applications, and teaching about it here.
        Check my <a target="_blank" href="https://github.com/patricksilva1">GitHub</a> </p>
        ...
        <ul class="text-lg sm:text-xl space-y-6">
          ...
          <li class="checkmark">
            ...
            <div class="text-lg text-gray-600">A modern implementation for an interface that two computer systems use to
              securely exchange information over the internet. <a target="_blank"
                href="https://github.com/patricksilva1/API-Restfull-PostgreSQL">Look here</a></div>

          </li>
          <li class="checkmark">
            <div>PhotoApp + Spring boot + Microservices</div>
    ...
    <div class="overflow-x-hidden border-gray-200 border-b">
      ...
      <div class="get-to-know-me container-inner mx-auto text-xl pb-16 relative">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-center mb-16">
          ...
          <div class="flex-1 text-lg sm:text-xl ml-6"> “ The starting point of all achievement is DESIRE. Keep this
            constantly in mind. Weak desire brings weak results, just as a small fire makes a small amount of heat. “
            <p>— Napoleon Hill</p>
          </div>
        </div>
        <!--
    ...
    <div class="overflow-x-hidden">
      ...
      <div class="contact-me bg-background-secondary pt-16">
        <div class="container-inner mx-auto text-xl pb-4 relative">
          ...
          <p class="mb-12"> I'm highly energetic in using my experience in Network Security,
            Interfaces and Software Development to work together. :)
          <p> Send me a message via <a target="_blank" href="https://wa.me/5521968160589">WhatsApp
            </a> or Send me an email, let's talk:</p>
          </p>
          <br>

          <div class="text-lg sm:text-lg mb-16">
            <form action="https://formspree.io/f/xrgdvbwa" method="POST" class="mb-12">
    ...
    <div class="newsletter bg-background-tertiary">
      ...
      <div class="container-inner mx-auto py-16 pb-8 text-center textl-xl">
        ...
        <div class="w-4/5 mx-auto mb-8">
          <p class="mb-8 text-lg sm:text-xl">Email newsletter sign ups don’t have to be boring! Sign up to receive more
            information about technology.</p>
