    ...
    <header class="top-0 left-0 z-40 fixed w-full border-t-14 border-green-700">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        ...
        <ul
          ...
          :class="isOpen ? 'block' : 'hidden'" data-cypress="menu">
          ...
          <li>
            <a v-if="$route.path === '/'" href="/#projects" v-scroll-to="{ el: '#projects', offset: -25 }"
              class="text-copy-primary hover:text-gray-600" data-cypress="projects">Projects</a>
            <g-link v-else to="/#projects" class="text-copy-primary hover:text-gray-600">Projects</g-link>
          </li>
          <li>
            <a v-if="$route.path === '/'" href="/#about" v-scroll-to="{ el: '#about', offset: -90 }"
              class="text-copy-primary hover:text-gray-600" data-cypress="about">About</a>
            <g-link v-else to="/#about" class="text-copy-primary hover:text-gray-600">About</g-link>
          </li>
          <li>
            <a v-if="$route.path === '/'" href="/#contact" v-scroll-to="{ el: '#contact', offset: -25 }"
              class="text-copy-primary hover:text-gray-600" data-cypress="contact">Contact</a>
    ...
    <footer class="bg-green-700 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center space-x-8">
          <li>
            <a href="mailto:patricksilva5160@gmail.com" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://github.com/patricksilva1" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://twitter.com/@patricksilvaa98" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://instagram.com/patricksilva.me" target="_blank" class="text-white hover:text-gray-400">
